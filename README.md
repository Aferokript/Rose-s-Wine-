...
4. pip install python-dotenv==0.9.9   # Обратите внимание: python-dotenv, а не python_dotenv
...
После, с помощью библиотеки python-dotenv загружаем данные в маин из енв:
